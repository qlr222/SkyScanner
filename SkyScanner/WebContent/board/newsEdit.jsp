					...
					<div class="board-view board-write">
						...
						<div class="content mb-2r">
							<div class="write-form">
								<form action="<%=request.getContextPath()%>/board?cmd=newsEditProc&num=${view.num}" method="post">									
									<div class="col-md-3">
									...
									<div class="col-md-9 mb-1r">
										<input type="text" name="title" class="input-title form-control" placeholder="제목을 입력하세요.(최대 30자)" maxlength="100" value="${view.title}" autofocus required>
									</div>
									<textarea name="contentText" rows="8" cols="80" class="form-control mb-2r" placeholder="내용을 입력하세요." required>${view.content}</textarea>

									<!--btns-->
									<a href="<%=request.getContextPath()%>/board?cmd=news" class="btn book-btn dark">목록</a>
									<input type="submit" class="btn book-btn float-right" value="수정하기">
								</form>
							</div>
						</div>
					</div>
